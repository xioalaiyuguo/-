...
@interface mymessage1ViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation mymessage1ViewController
...
- (void)viewDidLoad {
    ...
    self.telbtn = [[UIButton alloc]initWithFrame:CGRectMake(15, 522, 290, 42)];
    [self.telbtn setBackgroundColor:COLOR(92, 206, 150, 1)];
